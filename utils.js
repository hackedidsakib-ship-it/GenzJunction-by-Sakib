...
if (!clientId) {
        log.warn("CREDENTIALS", `Google clientId not set — Google Drive/Gmail features disabled.`);
}
if (!clientSecret) {
        log.warn("CREDENTIALS", `Google clientSecret not set — Google Drive/Gmail features disabled.`);
}
if (!refreshToken) {
        log.warn("CREDENTIALS", `Google refreshToken not set — Google Drive/Gmail features disabled.`);
}

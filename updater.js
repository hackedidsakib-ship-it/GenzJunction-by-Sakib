...
(async () => {
        const { data: lastCommit } = await axios.get(`https://api.github.com/repos/${GITHUB_REPO}/commits/${GITHUB_BRANCH}`, {
        ...
        for (const filePath in files) {
                ...
                let getFile;
                try {
                        const response = await axios.get(`https://github.com/${GITHUB_REPO}/raw/${GITHUB_BRANCH}/${filePath}`, {
        ...
        const { data: packageHTML } = await axios.get(`https://github.com/${GITHUB_REPO}/blob/${GITHUB_BRANCH}/package.json`, {
                headers: GITHUB_HEADERS
        });
